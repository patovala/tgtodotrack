...
It's perfectly fine to re-use this definition in the tgtodotrack application,
though.
...
class User(DeclarativeBase):
    ...
    # RZ - Step18 modificar la relación con actividades
    actividades = relation('Actividad', backref='usuario')
